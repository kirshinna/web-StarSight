...
**Ссылка на рабочий проект:** [https://kirshina.pythonanywhere.com](https://kirshina.pythonanywhere.com)
...
```bash
git clone https://github.com/ваш-юзернейм/star-sight.git
cd star-sight
```
...
Для доступа к административной панели Django перейдите по адресу: [http://127.0.0.1:8000/admin/](http://127.0.0.1:8000/admin/)
